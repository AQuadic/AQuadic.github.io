                        ...
                        <div className="modal-body">
                            ...
                            <div className="modal_title">
                                ...
                                <div className="modal_app">
                                    {
                                        currentProject.links.app_store ?
                                            <a href="#"> <img src="/images/apps/app_store.svg" alt=""/></a> : null
                                    }

                                    {
                                        currentProject.links.play_store ?
                                            <a href="#"><img src="/images/apps/google_play.svg" alt=""/></a> : null
                                    }
