    ...
    <div className='job'>
        <Container>
            ...
            <ul>
                ...
                <li>Build multi-platform apps for iOS and Android using Google’s Flutter development framework. </li>
                <li>Design and develop high-volume, low-latency applications and deliver high availability and performance. </li>
                <li>Build reusable code and libraries for future use. </li>
                <li>Write well designed, scalable, robust, testable, efficient, and easily maintainable code </li>
                ...
                <li>Work in an Agile environment of fast and efficient delivery without compromising product quality</li>
