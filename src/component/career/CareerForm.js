    ...
    axios({
      ...
      .catch((err) => {
        ...
        err.response.data.errors.subject
          ...
          : setErrorSubject("");
        err.response.data.errors.attachment
          ? setErrorFile(err.response.data.errors.attachment)
          : setErrorFile("");
      });
  };
            ...
            <Form className="row">
              <Form.Group className="col-12  col-sm-6 mb-4">
                ...
                <Form.Control
                  ...
                  value={name}
                />
                {errorName ? <div className="errorinput">{errorName}</div> : ""}
              </Form.Group>
              <Form.Group className="col-12 col-sm-6 mb-4">
                <Form.Label>
                  <div>
              ...
              <div className="upload col-12 col-sm-12">
                ...
                {errorFile ? <div className="errorinput">{errorFile}</div> : ""}
              </div>
              <Button
